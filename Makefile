...
debugwa:
	@ddd --debugger arm-none-eabi-gdb ${COMPILER}/${PROJECTNAME}.axf &
	emulator -verbose -show-kernel -netfast -avd hd2 -shell -system ../sdk/system-images/android-15/default/armeabi-v7a/system.img
 -qemu -monitor telnet::6666,server -s -S -kernel ${COMPILER}/${PROJECTNAME}.bin
